...
<div class="categories">
    <div class="small-container1">
        <div class="row">
            <div class="col-3">
                <img src="../image/pic-11.png" class="slide-item">
            </div>
            <div class="col-3">
                <img src="../image/pic-2.png" class="slide-item">
            </div>
            <div class="col-3">
                <img src="../image/pic-3.png" class="slide-item">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-4">
            ...
            <div class="pen2">
                ...
                <div class="pen1">
                     <a href ="../php/UpdateAddItems.php?id=<?php echo $row['id']; ?>"><img src="../image/pen.png"></a>
                </div>
